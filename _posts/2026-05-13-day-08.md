...
while [ $ATTEMPT -le $MAX_ATTEMPTS ]; do
    if docker exec ldap-server ldapsearch -x -H ldap://localhost:389 -b "dc=mycompany,dc=com" -D "uid=admin,dc=mycompany,dc=com" -w "newpassword123" >/dev/null 2>&1; then
...
ldapadd -c -x -D "uid=admin,dc=mycompany,dc=com" -w newpassword123 -f /tmp/data.ldif'
